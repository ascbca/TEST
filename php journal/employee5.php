...
<body>
    ...
    <!-- Employee Form -->
    <form action="employee5.php" method="POST">
    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['DOJ'] . "</td>";
                echo "<td><a href='employee5.php?edit=" . $row['EmpNo'] . "'>Edit</a> | <a href='employee5.php?delete=" . $row['EmpNo'] . "' onclick='return confirm(\"Are you sure?\")'>Delete</a></td>";
                echo "</tr>";
            }
        } else {
